...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
		    <label for="inputNome" id="cabec">Nome</label>
		  ...
		  <div class="form-group">
		    <label for="exampleInputEmail1" id="cabec">Email</label>
		  ...
		  <div class="form-group">
		    <label for="exampleInputPassword1" id="cabec">Senha</label>
